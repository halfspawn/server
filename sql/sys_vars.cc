...
static Sys_var_enum Sys_column_compression_zlib_strategy(
       ...
       "DEFAULT_STRATEGY and HUFFMAN_ONLY. RLE is designed to be almost as fast as "
       "HUFFMAN_ONLY, but give better compression for PNG image data. The strategy "
       "parameter only affects the compression ratio but not the correctness of the "
       "compressed output even if it is not set appropriately. FIXED prevents the "
